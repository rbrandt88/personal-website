        ...
        <>
            <div className='inventory-management-container'>
                ...
                <p>Inventory management is a time consuming task. First, online marketplace orders have to be recorded and tracked. Second, inventory is listed on Amazon and shipped to their warehouse.  
                    Lastly, it is repriced and recorded when it has sold. This solution addresses these probelems efficiently and effectivly. </p>
                <hr></hr>
                <h2>Recording Orders</h2>
                <p>Unfortunately, many online marketplaces do not offer an api to the general public. To work around this, order data has to be scraped with beautiful soup and slelenium.
                ...
                <hr></hr>
                <h2>Repricing</h2>
                <p>Typical repricing software only takes in the data from Amazon's api. This often doesn't include historic pricing data and sellers stock numbers. 
                    In order to price an item most effectivly, these statistics need to be factored in. This is exactly what my repricer does. It factors in all these variables and gives me a target price and target time to sell.
                    </p>
                <hr></hr>
                ...
                <p>Data is downloaded off of Amazon in text format. The text file is parsed, grouped by transaction, and recorded in the database. 
                    Multiple stats functions are responsible for returns the key business metrics. Essentially, they query the database and return the values. A few to name are Average Profit, Inventory Evaluation, and Marketplace Profitability. 
                </p>
                <hr></hr>
                <h2>Impact</h2>
