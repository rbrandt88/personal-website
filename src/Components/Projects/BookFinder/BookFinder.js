    ...
    return (
        <>
            <div className='book-finder-container'>
                ...
                <p><h4 className='project-brief'>Brief: </h4>Searches online marketplaces for underpriced books that can be resold on Amazon. Text and image data are used to confirm a match in the database. Candidates for purchase are sent to me via text message</p>
                ...
                <ul>
                    ...
                    <li>Maintained data integrity Pytest</li>
                    <li>Computer Vision techniques (RANSAC, SIFT, Filtering) </li> 
                 
                </ul>
                <hr></hr>
                <h2>Problem Statement</h2> 
                <p> Finding underpriced books online takes a long time. Each listing has to be looked up one by one manually. This process is horribly inefficient. In addition to this, listings are often weakly labeled, e.g. Image 1. 
                    The program must be able to deal with this and make accurate matches with whatever data is available.
                </p>
                <img className='example-image' src={require('./Media/online_example.png')} alt="example"></img>
                <p>Image 1: Weakly labeled listings</p>
                <hr></hr>
                <h2>Data Description</h2>
                <p>The book dataset was collected by scraping Amazon. Around 15,000 books were found to match my specific reselling criteria.
                ...
                <p> Text and image data are scraped asynchronously from websites using the asyncio library and Beautiful Soup. 
                    ...
                    If the top match satisfies the threshold for similarity, the listing is sent to me via text message. 
                    
                    To ensure web scraping accuracy, I frequently run tests with pytest. 
                     </p>
                <hr></hr>
                <h2>Impact</h2>
                <p> This program is at the core of my business and is responsible for hundreds of thousands of dollars in sales.
                    I am able to save hours of searching time and focus on other aspects of my business.
                    
                    </p>
                <hr></hr>
                <h2>Future Improvements</h2>
                <p>Every now and then, a false positive is sent to me. These are usually old editions matching to a new one. 
